/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 3ee4f74082b39c7bf5666114375981ba)
// Runtime types generated with workerd@1.20260708.1 2025-07-15 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	ASSETS: Fetcher;
	GITHUB_USERNAME: "blck-snwmn";
	GITHUB_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_USERNAME" | "GITHUB_TOKEN">> {}
}
